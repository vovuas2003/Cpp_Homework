...
class TripleBonus : public Bonus {
public:
    TripleBonus(sf::Vector2f position): Bonus(position) {}; 
...
// Рисуем бонус
void TripleBonus::draw(sf::RenderWindow& window) const
{
    // Рисуем белый круг
...
void TripleBonus::activate(Arkanoid& game)
{
